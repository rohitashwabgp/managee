class Calculator extends HTMLElement { // (1)
    connectedCallback() {
        this.innerHTML = `<form name="sci-calc">
...
function addCustomElementCalculator() {
  customElements.define("app-calculator", Calculator); // (2)
  console.log("Added MyElement to custom element registry!");
}
addCustomElementCalculator();